        ...
        while ((working_hours <= total_working_hrs) && (working_days <= total_working_days)) {
            ...
            switch (employee) {
                case 0: {
                    ...
                    int fulltimeempwage = wage.fulltimeWage(wage_per_hour, fworking_hours, working_hours);
                ...
                case 1: {
                    ...
                    int parttimeempwage = wage.parttimeWage(wage_per_hour, pworking_hours, working_hours);
